...
import LineCh from '../mqtt/Line/LineChart.js';
...
class LineChart extends React.Component{
    ...
    getName(name) {
        ...
        var objct = {id:this.props.id, type: this.props.chartType, name: this.name,
                    ...
                    position:oldObject.position, changed: false}
    ...
    changeSettings(name, url, topic, numberOfValues) {
        if(name != "") {
            this.name = name;
        }
                    ...
                    <Card className="card-chart">
                            ...
                            <UncontrolledDropdown className="cancel-drag">
                                ...
                                <DropdownMenu right>
                                    <DropdownItem onClick={this.updateModal}>Change Settings</DropdownItem>
                                      { this.state.modal ? <LineModal className="cancel-drag" updateParent={this.updateModal} name={this.name} url={this.url} topic={this.topic} numberOfValues={this.numberOfValues} changeSettings={this.changeSettings} /> : null }
                        ...
                        <CardBody>
                            <div align="center" className="cancel-drag">
                                <LineCh key={this.getKey()} id={this.props.id} ref='shouldUpdateChild' name={this.name} url={this.url} topic={this.topic} authentication={this.props.authentication} user={this.props.user} password={this.props.password} numberOfValues={this.numberOfValues} valuesToFather={this.getName} />
                            </div>
                        </CardBody>
                    </Card>
            );
