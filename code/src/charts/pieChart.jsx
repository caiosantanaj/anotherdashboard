...
import PieCh from '../mqtt/Pie/PieChart.js';
...
class PieChart extends React.Component{
    ...
    getName(name) {
        ...
        var objct = {id:this.props.id, type: this.props.chartType, name: this.name,
                     url: this.url, topic: this.topic, numberOfValues: this.numberOfValues, auth:this.props.authentication,
                    ...
                    <Card className="card-chart">
                            ...
                            <UncontrolledDropdown className="cancel-drag">
                                ...
                                <DropdownMenu right>
                                    <DropdownItem onClick={this.updateModal}>Change Settings</DropdownItem>
                                      { this.state.modal ? <PieModal className="cancel-drag" updateParent={this.updateModal} name={this.name} url={this.url} topic={this.topic} changeSettings={this.changeSettings} /> : null }
                        ...
                        <CardBody>
                            <div align="center" className="cancel-drag">
                                <PieCh key={this.getKey()} id={this.props.id} ref='shouldUpdateChild' name={this.name} url={this.url} topic={this.topic} authentication={this.props.authentication} user={this.props.user} password={this.props.password} valuesToFather={this.getName} />
                            </div>
                        </CardBody>
                    </Card>
            );
...
class PieModal extends React.Component{
    ...
    render() {
      return (
        <Modal isOpen={this.state.modalIsOpen} closeRequest={this.closeRequest} className={this.props.className}>
            <ModalHeader toggle={this.closeRequest}>Pie Chart Settings</ModalHeader>
            <ModalBody>
                <form>
                    <FormGroup row>
