...
import BubbleCh from '../mqtt/Bubble/BubbleChart.js';
                    ...
                    <Card className="card-chart">
                            ...
                            <UncontrolledDropdown className="cancel-drag">
                                ...
                                <DropdownMenu right>
                                    <DropdownItem onClick={this.updateModal}>Change Settings</DropdownItem>
                                        { this.state.modal ? <BubbleModal className="cancel-drag" updateParent={this.updateModal} name={this.name} url={this.url} topic={this.topic} changeSettings={this.changeSettings} /> : null }
                        ...
                        <CardBody>
                            <div align="center" className="cancel-drag">
                                <BubbleCh key={this.getKey()} id={this.props.id} ref='shouldUpdateChild' name={this.name} url={this.url} topic={this.topic} authentication={this.props.authentication} user={this.props.user} password={this.props.password} nameToFather={this.getName} />
                                <br/>
                            </div>
                        </CardBody>
                    </Card>
...
class BubbleModal extends React.Component{
    ...
    render() {
      return (
        <Modal isOpen={this.state.modalIsOpen} closeRequest={this.closeRequest} className={this.props.className}>
                    <ModalHeader toggle={this.closeRequest}>Bubble Chart Settings</ModalHeader>
                    <ModalBody>
                        <form>
                            <FormGroup row>
